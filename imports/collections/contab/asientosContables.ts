...
const partidas_SimpleSchema = new SimpleSchema({
...
export const AsientosContables_SimpleSchema = new SimpleSchema({
    numeroAutomatico: { type: Number, label: "Número automático", optional: false, },
    ...
    copiableFlag: { type: Boolean, label: "Copiable?", optional: true },
