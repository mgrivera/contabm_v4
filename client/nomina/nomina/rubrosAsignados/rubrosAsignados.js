...
angular.module("contabm").controller("RubrosAsignados_Controller", ['$scope', '$meteor', function ($scope, $meteor) {
    ...
    $scope.helpers({
        maestraRubros: () => {
            return MaestraRubros.find({}, {
                fields: { rubro: 1, nombreCortoRubro: 1 },
    ...
    leerListaEmpleados($scope.companiaSeleccionada.numero)
        .then((result0) => {
            ...
            $scope.rubros_ui_grid.columnDefs[5].editDropdownOptionsArray = $scope.empleados;
